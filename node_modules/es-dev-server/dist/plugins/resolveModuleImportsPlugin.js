...
async function createSyntaxError(code, filePath, originalError) {
    ...
    // browser
    console.error(`Could not resolve module imports in ${filePath}: Unable to parse the module, this can be due to experimental syntax or a bug in the parser.`);
    throw originalError;
}
/**
